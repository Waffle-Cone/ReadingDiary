...
data class Entry(var id: Int, var title: String, var pageFrom: Int =0, var pageTo: Int =0, var rating: Int = 0, var comment: String = "", var dateTime: LocalDateTime =LocalDateTime.now()){
